      ...
      >
        ...
        <div className="flex justify-end space-x-3 mt-6">
          <button
            onClick={onClose}
            disabled={isLoading}
            className="px-4 py-1.5 bg-brand-secondary dark:bg-dark-secondary text-brand-text-primary dark:text-dark-text-primary font-semibold rounded-lg hover:bg-brand-tertiary dark:hover:bg-dark-tertiary transition-colors duration-200 disabled:opacity-50 border border-brand-border dark:border-dark-border text-sm"
          >
            Άκυρο
          </button>
          <button
            ...
            className="px-4 py-1.5 bg-brand-accent text-white font-semibold rounded-lg hover:bg-brand-accent-dark transition-colors duration-200 disabled:bg-slate-300 dark:disabled:bg-slate-600 disabled:cursor-not-allowed shadow-sm text-sm"
          >
